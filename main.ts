...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile8
    `, function on_overlap_tile2(sprite11: Sprite, location11: tiles.Location) {
    if (level == 2) {
        play_game_3()
    }
...
function menu() {
    ...
    if (level == 0) {
        game.showLongText("Get pass all levels to win!", DialogLayout.Bottom)
    }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile2
    `, function on_overlap_tile3(sprite12: Sprite, location12: tiles.Location) {
    info.changeLifeBy(-1)
    sprites.destroyAllSpritesOfKind(SpriteKind.Player)
    play_game_2()
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile3
    `, function on_overlap_tile4(sprite9: Sprite, location9: tiles.Location) {
    info.changeLifeBy(-1)
    sprites.destroyAllSpritesOfKind(SpriteKind.Player)
    play_game_2()
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile9
    `, function on_overlap_tile6(sprite8: Sprite, location8: tiles.Location) {
    if (level == 3) {
        play_game_4()
    }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile1
    `, function on_overlap_tile7(sprite2: Sprite, location2: tiles.Location) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile4
    `, function on_overlap_tile8(sprite7: Sprite, location7: tiles.Location) {
    sprites.destroyAllSpritesOfKind(SpriteKind.Player)
    if (level == 4) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile6
    `, function on_overlap_tile9(sprite3: Sprite, location3: tiles.Location) {
    if (level == 1) {
        play_game_2()
    }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile7
    `, function on_overlap_tile10(sprite6: Sprite, location6: tiles.Location) {
    player2.vy = -300
})
//  Funció que s'executa quan un sprite de tipus SpriteKind.player es superposa a un mosaic específic.
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile5
    `, function on_overlap_tile11(sprite13: Sprite, location13: tiles.Location) {
    if (level == 0) {
        play_game_1()
    }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile
    `, function on_overlap_tile12(sprite4: Sprite, location4: tiles.Location) {
    info.changeLifeBy(-1)
    sprites.destroyAllSpritesOfKind(SpriteKind.Player)
    if (level == 1) {
        play_game_1()
...
//  Redueix les vides en 1, elimina tots els sprites del tipus SpriteKind.player i
//  si level es 4 crida a la funció play_game_4 sino final_game.
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.hazardLava0, function on_overlap_tile13(sprite5: Sprite, location5: tiles.Location) {
    info.changeLifeBy(-1)
    sprites.destroyAllSpritesOfKind(SpriteKind.Player)
    if (level == 4) {
        play_game_4()
